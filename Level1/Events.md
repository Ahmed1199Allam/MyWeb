...
<a id="rcorners_events" href="{{site.baseurl}}/Events/Cybersecurity" style="float: left;background: url({{site.baseurl}}/assets/Images/Cyber@300.png);"></a>

<a id="rcorners_events" href="{{site.baseurl}}/Events/DeepLearningForSelfDrivingCars" style="float: left; margin-right: 0; background: url({{site.baseurl}}/assets/Images/Deep@300.png);"></a>

<a id="rcorners_events" href="{{site.baseurl}}/Events/InfoSession" style="float: right; margin-right: 0; background: url({{site.baseurl}}/assets/Images/info@300.png);"></a>
